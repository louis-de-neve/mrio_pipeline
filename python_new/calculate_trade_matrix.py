...
def calculate_trade_matrix(
    ...
    trade_filename = "../Trade_DetailedTradeMatrix_E_All_Data_(Normalized).csv"
    reporting_filename = "../Reporting_Dates.xls"
    content_filename = "../content_factors_per_100g.xlsx"
    production_crops_filename = "../Production_Crops_E_All_Data_(Normalized).csv"
    production_animal_filename = "../Production_LivestockPrimary_E_All_Data_(Normalized).csv"
    profuction_offals_filename = "../CommodityBalances_LivestockFish_E_All_Data_(Normalized).csv"
    sugar_processing_filename = "../CommodityBalances_Crops_E_All_Data_(Normalized).csv"
